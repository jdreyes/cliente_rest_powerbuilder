namespace
namespace PostalCodeAutentiaService
end namespace
forward
global type PostalCodeTutoProxy from nonvisualobject
end type
end forward

global type PostalCodeTutoProxy from nonvisualobject
end type
global PostalCodeTutoProxy PostalCodeTutoProxy
...
on PostalCodeTutoProxy.create
call super::create
TriggerEvent( this, "constructor" )
end on

event constructor;
    m_service = create PBWebHttp.RestService("http://maps.googleapis.com/maps/api/directions/json?origin=Madrid,%20ES&destination=Barcelona,%20ES&sensor=false", PBWebHttp.WebMessageFormat.Json!)
    // Connection Object
    restConnectionObject = create PBWebHttp.WebConnection
    restConnectionObject.Endpoint = "http://maps.googleapis.com/maps/api/directions/json?origin=Madrid,%20ES&destination=Barcelona,%20ES&sensor=false"
    restConnectionObject.ResponseMessageFormat = PBWebHttp.WebMessageFormat.Json!

end event


on PostalCodeTutoProxy.destroy
